...
public class HDDRandomAccess implements IBenchmark {
    ...
    private final static String PATH = "E:\\JavaExercises\\Writes\\test.dat";
    ...
    class RandomAccess {
        ...
        public long randomReadFixedSize(String filePath, int bufferSize,
            ...
            while (counter++ < toRead) {
                ...
                bytes = readFromFile(filePath, random.nextInt(fileSize) & Integer.MAX_VALUE, bufferSize);
            }
        ...
        public long randomWriteFixedSize(String filePath, int bufferSize,
            ...
            while (counter++ < toWrite) {
                ...
                writeToFile(filePath, new String(bytes, Charset.defaultCharset()), random.nextInt(fileSize) & Integer.MAX_VALUE);
            }
         ...
         *            Full path to file on disk
         * @param bufferSize
         *            Size of byte buffer to write at each step
         * @param millis
         *            Total time to read from file
         * @return Number of reads in the given amount of time
         * @throws IOException
